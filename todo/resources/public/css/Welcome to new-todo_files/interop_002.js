...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__44887 = cljs.core.instance_QMARK_;
var expr__44888 = reactive_val;
if(cljs.core.truth_(pred__44887.call(null,reagent.ratom.RAtom,expr__44888))){
return "ra";
} else {
if(cljs.core.truth_(pred__44887.call(null,reagent.ratom.RCursor,expr__44888))){
return "rc";
} else {
if(cljs.core.truth_(pred__44887.call(null,reagent.ratom.Reaction,expr__44888))){
return "rx";
} else {
if(cljs.core.truth_(pred__44887.call(null,reagent.ratom.Track,expr__44888))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1502518459548
