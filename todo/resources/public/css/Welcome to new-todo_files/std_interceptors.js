...
var vec__45314_45317 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_45318 = cljs.core.nth.call(null,vec__45314_45317,(0),null);
var only_after_45319 = cljs.core.nth.call(null,vec__45314_45317,(1),null);
var db_changed_QMARK__45320 = (!((only_before_45318 == null))) || (!((only_after_45319 == null)));
if(db_changed_QMARK__45320){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_45318);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_45319);
...
var map__45321 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__45321__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__45321__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__45323 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__45323__$1;
var event = cljs.core.get.call(null,map__45323__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__41356__auto___45326 = arguments.length;
var i__41357__auto___45327 = (0);
while(true){
if((i__41357__auto___45327 < len__41356__auto___45326)){
args__41363__auto__.push((arguments[i__41357__auto___45327]));

var G__45328 = (i__41357__auto___45327 + (1));
i__41357__auto___45327 = G__45328;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__41364__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq45325){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45325));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__40192__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__41363__auto__ = [];
var len__41356__auto___45334 = arguments.length;
var i__41357__auto___45335 = (0);
while(true){
if((i__41357__auto___45335 < len__41356__auto___45334)){
args__41363__auto__.push((arguments[i__41357__auto___45335]));

var G__45336 = (i__41357__auto___45335 + (1));
i__41357__auto___45335 = G__45336;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__41364__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__45329_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__45330_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__45330_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq45331){
var G__45332 = cljs.core.first.call(null,seq45331);
var seq45331__$1 = cljs.core.next.call(null,seq45331);
var G__45333 = cljs.core.first.call(null,seq45331__$1);
var seq45331__$2 = cljs.core.next.call(null,seq45331__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__45332,G__45333,seq45331__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1502518460230
