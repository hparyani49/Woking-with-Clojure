...
var or__40192__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj51329 = {"detail":data};
return obj51329;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__40180__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__40180__auto__)){
var and__40180__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__51336 = cljs.core._EQ_;
var expr__51337 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__51336.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__51337))){
return ((function (pred__51336,expr__51337){
return (function (p1__51330_SHARP_){
return console.warn(p1__51330_SHARP_);
});
;})(pred__51336,expr__51337))
} else {
if(cljs.core.truth_(pred__51336.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__51337))){
return ((function (pred__51336,expr__51337){
return (function (p1__51331_SHARP_){
return console.debug(p1__51331_SHARP_);
});
;})(pred__51336,expr__51337))
} else {
if(cljs.core.truth_(pred__51336.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__51337))){
return ((function (pred__51336,expr__51337){
return (function (p1__51332_SHARP_){
return console.error(p1__51332_SHARP_);
});
;})(pred__51336,expr__51337))
} else {
return ((function (pred__51336,expr__51337){
return (function (p1__51333_SHARP_){
return console.log(p1__51333_SHARP_);
});
;})(pred__51336,expr__51337))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__51340){
...
var opts = map__51341__$1;
var eval_fn = cljs.core.get.call(null,map__51341__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__51343_SHARP_){
return new_def.callback(p1__51343_SHARP_);
});})(new_def))
);
...
return (function (p__51344){
var vec__51345 = p__51344;
var ky = cljs.core.nth.call(null,vec__51345,(0),null);
var v = cljs.core.nth.call(null,vec__51345,(1),null);
...
if(cljs.core.truth_((function (){var and__40180__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1502518467689
