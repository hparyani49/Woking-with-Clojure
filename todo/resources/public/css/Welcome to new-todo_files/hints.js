...
var reader = (function (){var or__32437__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__32437__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__32437__auto__)){
return or__32437__auto__;
} else {
return (128);
...
}catch (e37384){var _e = e37384;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___37387 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___37387)){
var seen_errors_37388 = temp__4655__auto___37387;
if(cljs.core.truth_(seen_errors_37388.has(self))){
} else {
seen_errors_37388.add(self);

var temp__4657__auto___37389 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___37389)){
var sense_37390 = temp__4657__auto___37389;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),cljs.core.str.cljs$core$IFn$_invoke$arity$1(", a sanity hint:\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_37390)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1502190263843
