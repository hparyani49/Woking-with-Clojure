...
var len__33601__auto___35599 = arguments.length;
var i__33602__auto___35600 = (0);
while(true){
if((i__33602__auto___35600 < len__33601__auto___35599)){
args__33608__auto__.push((arguments[i__33602__auto___35600]));

var G__35601 = (i__33602__auto___35600 + (1));
i__33602__auto___35600 = G__35601;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__33609__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq35596){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__35597,G__35598,seq35596__$2);
});
...
if(cljs.core.truth_((function (){var or__32437__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__33062__auto__,writer__33063__auto__,opt__33064__auto__){
return cljs.core._write.call(null,writer__33063__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__32425__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__32425__auto__){
var or__32437__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__32437__auto__)){
return or__32437__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__35602_SHARP_){
return !((cljs.core.meta.call(null,p1__35602_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__35603__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__32437__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e35607){var _e__35333__auto__ = e35607;
return false;
}})();
if(cljs.core.truth_(or__32437__auto__)){
return or__32437__auto__;
...
}catch (e35609){var _e__35333__auto__ = e35609;
return false;
}}
})())){
...
var _STAR_current_state_STAR_35611 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__35612 = opts;
...
var markup_db = cljs.core.get.call(null,map__35612__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_35611;
}});
...
;
var temp__4655__auto___35616 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___35616)){
var managed_print_level_35617 = temp__4655__auto___35616;
var _STAR_print_level_STAR_35615_35618 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_35617;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_35615_35618,managed_print_level_35617,temp__4655__auto___35616,writer,opts,job_fn){
return (function (p1__35614_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__35614_SHARP_,null);
});})(_STAR_print_level_STAR_35615_35618,managed_print_level_35617,temp__4655__auto___35616,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_35615_35618;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1502190260488
