...
var G__35570 = devtools.prefs.pref.call(null,v);
v = G__35570;
continue;
} else {
return v;
...
var and__32425__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__32425__auto__){
var and__32425__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__32437__auto__ = (function (){try{if(!((value == null))){
...
}catch (e35573){var _e__35333__auto__ = e35573;
return false;
}})();
if(cljs.core.truth_(or__32437__auto__)){
return or__32437__auto__;
} else {
var or__32437__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e35577){var _e__35333__auto__ = e35577;
return false;
}})();
...
}catch (e35579){var _e__35333__auto__ = e35579;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__32425__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__32425__auto__)){
var and__32425__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__32425__auto____$1){
...
var and__32425__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__32425__auto__)){
...
var or__32437__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__32437__auto__)){
return or__32437__auto__;
} else {
...
var and__32425__auto__ = (function (){var or__32437__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__32437__auto__)){
return or__32437__auto__;
} else {
...
var vec__35581 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__35581,(0),null);
var name = cljs.core.nth.call(null,vec__35581,(1),null);
...
var and__32425__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__32425__auto__)){
...
var or__32437__auto__ = typeof value === 'string';
if(or__32437__auto__){
return or__32437__auto__;
} else {
var or__32437__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__35584_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__35584_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1502190260369
