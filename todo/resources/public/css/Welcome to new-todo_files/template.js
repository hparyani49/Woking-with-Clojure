...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__33062__auto__,writer__33063__auto__,opt__33064__auto__){
return cljs.core._write.call(null,writer__33063__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__35118 = o;
(G__35118[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__35119__delegate = function (args){
...
while (G__35120__i < G__35120__a.length) {G__35120__a[G__35120__i] = arguments[G__35120__i + 0]; ++G__35120__i;}
  args = new cljs.core.IndexedSeq(G__35120__a,0,null);
} 
...
var args = cljs.core.seq(arglist__35121);
...
if(cljs.core.truth_((function (){var and__32425__auto__ = !((jsprops == null));
if(and__32425__auto__){
var and__32425__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__35124 = jsprops;
(G__35124["defaultValue"] = value);

(G__35124["onChange"] = ((function (G__35124,v,value,on_change){
return (function (p1__35123_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__35123_SHARP_);
});})(G__35124,v,value,on_change))
);
...
var vec__35127 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__35127,(0),null);
var id = cljs.core.nth.call(null,vec__35127,(1),null);
var class$ = cljs.core.nth.call(null,vec__35127,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___35131 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___35131 == null)){
} else {
var key_35132 = temp__4661__auto___35131;
...
var G__35133 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__35133["name"] = c);
...
var len__33601__auto___35138 = arguments.length;
var i__33602__auto___35139 = (0);
while(true){
if((i__33602__auto___35139 < len__33601__auto___35138)){
args__33608__auto__.push((arguments[i__33602__auto___35139]));

var G__35140 = (i__33602__auto___35139 + (1));
i__33602__auto___35139 = G__35140;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__33609__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq35136){
var G__35137 = cljs.core.first.call(null,seq35136);
var seq35136__$1 = cljs.core.next.call(null,seq35136);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__35137,seq35136__$1);
});
...
break;
default:
var G__35143 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__35143;
continue;
...
var n__33377__auto___35145 = a.length;
var i_35146 = (0);
while(true){
if((i_35146 < n__33377__auto___35145)){
(a[i_35146] = reagent.impl.template.as_element.call(null,(a[i_35146])));
...
var a = cljs.core.into_array.call(null,s);
var n__33377__auto___35148 = a.length;
var i_35149 = (0);
while(true){
if((i_35149 < n__33377__auto___35148)){
var val_35150 = (a[i_35149]);
if((cljs.core.vector_QMARK_.call(null,val_35150)) && ((reagent.impl.template.key_from_vec.call(null,val_35150) == null))){
(o["no-key"] = true);
} else {
}

(a[i_35149] = reagent.impl.template.as_element.call(null,val_35150));

var G__35151 = (i_35149 + (1));
i_35149 = G__35151;
continue;
} else {
}
...
var ctx = ({});
var vec__35152 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__35152,(0),null);
var derefed = cljs.core.nth.call(null,vec__35152,(1),null);
...
var G__35155 = (cljs.core.count.call(null,argv) - first_child);
switch (G__35155) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__35155){
...
//# sourceMappingURL=template.js.map?rel=1502190259417
