...
var o35468 = temp__4655__auto__;
var temp__4655__auto____$1 = (o35468["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o35469 = temp__4655__auto____$1;
return (o35469["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__35326__auto__ = f;
return (o__35326__auto__["toString"]).call(o__35326__auto__);
} else {
return "";
}
}catch (e35470){var _ = e35470;
return "";
}});
...
try{var o__35326__auto___35472 = t;
(o__35326__auto___35472["cljs$lang$ctorPrWriter"]).call(o__35326__auto___35472,t,writer);
}catch (e35471){var __35473 = e35471;
}
...
var char_code = (function (){var o__35326__auto__ = (new String(char$));
return (o__35326__auto__["charCodeAt"]).call(o__35326__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__35326__auto__ = String;
return (o__35326__auto__["fromCharCode"]).call(o__35326__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__35474 = num_code;
switch (G__35474) {
case (1):
return (185);
...
var o__35326__auto__ = String;
return (o__35326__auto__["fromCharCode"]).call(o__35326__auto__,superscript_code);
});
/**
...
}catch (e35476){var _e__35333__auto__ = e35476;
return false;
}})())){
...
var vec__35477 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__35477,(0),null);
...
var or__32437__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o35480 = temp__4655__auto__;
var temp__4655__auto____$1 = (o35480["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o35481 = temp__4655__auto____$1;
return (o35481["nameToPath"]);
} else {
return null;
}
} else {
...
var len__33601__auto___35488 = arguments.length;
var i__33602__auto___35489 = (0);
while(true){
if((i__33602__auto___35489 < len__33601__auto___35488)){
args__33608__auto__.push((arguments[i__33602__auto___35489]));

var G__35490 = (i__33602__auto___35489 + (1));
i__33602__auto___35489 = G__35490;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__33609__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__35484){
var vec__35485 = p__35484;
var ns_detector = cljs.core.nth.call(null,vec__35485,(0),null);
var effective_detector = (function (){var or__32437__auto__ = ns_detector;
if(cljs.core.truth_(or__32437__auto__)){
return or__32437__auto__;
} else {
...
var G__35491 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__35492 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__35491;
remaining_tokens = G__35492;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq35482){
var G__35483 = cljs.core.first.call(null,seq35482);
var seq35482__$1 = cljs.core.next.call(null,seq35482);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__35483,seq35482__$1);
});
...
var vec__35496 = cljs.core.split_with.call(null,(function (p1__35495_SHARP_){
return cljs.core.not_EQ_.call(null,p1__35495_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__35496,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__35496,(1),null);
...
var vec__35499 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__35499,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__35499,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__35502 = cljs.core.rest.call(null,remaining_tokens);
var G__35503 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__35502;
name_tokens = G__35503;
continue;
} else {
...
var vec__35506 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__35506,(0),null);
var arity = cljs.core.nth.call(null,vec__35506,(1),null);
var vec__35509 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__35509,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__35509,(1),null);
var vec__35512 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__35512,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__35512,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__35512,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__35512,(3),null);
...
var vec__35518 = result;
var munged_ns = cljs.core.nth.call(null,vec__35518,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__35518,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__35518,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__35518,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__35518,(4),null);
var arity = cljs.core.nth.call(null,vec__35518,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__35522 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__35522,(0),null);
var args = cljs.core.nth.call(null,vec__35522,(1),null);
var vec__35525 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__35525,(0),null);
var name = cljs.core.nth.call(null,vec__35525,(1),null);
...
var G__35528 = (arity + (1));
var G__35529 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__35530){
var vec__35531 = p__35530;
var arity = cljs.core.nth.call(null,vec__35531,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__35531,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__32437__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__32437__auto__)){
return or__32437__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__35534_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__35535_SHARP_);
...
var args__33608__auto__ = [];
var len__33601__auto___35542 = arguments.length;
var i__33602__auto___35543 = (0);
while(true){
if((i__33602__auto___35543 < len__33601__auto___35542)){
args__33608__auto__.push((arguments[i__33602__auto___35543]));

var G__35544 = (i__33602__auto___35543 + (1));
i__33602__auto___35543 = G__35544;
continue;
} else {
}
break;
...
var argseq__33609__auto__ = ((((1) < args__33608__auto__.length))?(new cljs.core.IndexedSeq(args__33608__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__33609__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__35538){
var vec__35539 = p__35538;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__35539,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq35536){
var G__35537 = cljs.core.first.call(null,seq35536);
var seq35536__$1 = cljs.core.next.call(null,seq35536);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__35537,seq35536__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__32437__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__32437__auto__)){
return or__32437__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__32425__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__32437__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__32437__auto__)){
return or__32437__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__35547__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__35547__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__35547__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__35547__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__35548 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__35548,(0),null);
var fn_name = cljs.core.nth.call(null,vec__35548,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__35548,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__35548,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__35548,(4),null);
var arity = cljs.core.nth.call(null,vec__35548,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__32425__auto__ = protocol_ns;
if(cljs.core.truth_(and__32425__auto__)){
return cljs.core.not.call(null,(function (){var and__32425__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__32437__auto__ = protocol_part;
if(cljs.core.truth_(or__32437__auto__)){
return or__32437__auto__;
} else {
return fn_part;
...
var o__35326__auto__ = f;
return (o__35326__auto__["getBasis"]).call(o__35326__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__32425__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__32425__auto__)){
...
}catch (e35552){var _e__35333__auto__ = e35552;
...
var G__35553 = (obj[cljs.core.first.call(null,path)]);
...
var partition_bits = (function (){var or__32437__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__32437__auto__)){
return or__32437__auto__;
} else {
return (0);
...
return (function (accum,p__35555){
var vec__35556 = p__35555;
var bit = cljs.core.nth.call(null,vec__35556,(0),null);
var protocol = cljs.core.nth.call(null,vec__35556,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__35559){
var vec__35560 = p__35559;
var ns = cljs.core.nth.call(null,vec__35560,(0),null);
var name = cljs.core.nth.call(null,vec__35560,(1),null);
var selector = cljs.core.nth.call(null,vec__35560,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__35565,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__35565,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__35565,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__35563_SHARP_){
return (obj[cljs.core.first.call(null,p1__35563_SHARP_)]);
});})(name,sorted_matches,vec__35565,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1502190260272
